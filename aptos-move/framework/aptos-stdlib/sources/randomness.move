module aptos_std::randomness {
    ...
    public fun u64_range(_rng: &mut RandomNumberGenerator, _min_incl: u64, _max_excl: u64): u64 { 42 }
    public fun u256_range(_rng: &mut RandomNumberGenerator, _min_incl: u256, _max_excl: u256): u256 { 42 }
